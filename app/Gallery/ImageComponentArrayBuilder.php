...
final class ImageComponentArrayBuilder
{
    /**
     * @param Image $image
     ...
     * @return array
     */
    public static function build(Image $image, Imageable $imageable): array
    {
        $data = [
        ...
        return array_merge($data,
            self::position($imageable, $image->project->type), self::dimensions($imageable)
        );
    }
     ...
     * @return array
     */
    protected static function position(Imageable $imageable, Type $type): array
    {
        // Use given positions
     ...
     * @return array
     */
    protected static function dimensions(Imageable $imageable): array
    {
        return [
